import svgPaths from "./svg-1hw6yld455";
...
export default function InstructorGuideDiscussionGuideCore() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[16px] py-[24px] relative rounded-[8px] shadow-[0px_5px_24px_4px_rgba(13,0,77,0.05),0px_13px_19px_2px_rgba(13,0,77,0.1),0px_7px_8px_-4px_rgba(13,0,77,0.15)] size-full" data-name="Instructor Guide: Discussion Guide (Core)">
            ...
            <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0">
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                ...
                <Wrapper additionalClassNames="bg-[#0d004d]">
                  <p className="basis-0 font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#e8e8e8] text-[16px]">Core Socratic Dialogue</p>
                </Wrapper>
          ...
          <Wrapper2>
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <Text1 text="“Dr. Vance has 20 years of experience. What gives you confidence to question her judgment?”" />
                <Text1 text="“When is it appropriate for a junior person to challenge a senior authority?”" />
                <Text2 text="“How do you distinguish between healthy deference and blind obedience?”" />
              </div>
            </div>
          </Wrapper2>
          <Wrapper2>
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <Text1 text="“The data showed the issue twice under high stress. What does ‘within spec’ really mean here?”" />
                <Text1 text="“If you proceed and nothing goes wrong, were you still right to be concerned?”" />
                <Text2 text="“Whose job is it to decide what’s safe enough?”" />
              </div>
            </div>
          </Wrapper2>
          <Wrapper2>
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <Text1 text="“How did knowing about the jobs impact your thinking?”" />
                <Text1 text="“Is there a difference between loyalty to people and loyalty to the organization?”" />
                <Text2 text="“What would you want someone to do if they were in your position?”" />
              </div>
            </div>
          </Wrapper2>
          <Wrapper2>
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <Text1 text="“If Dr. Vance won’t listen, what are your options?”" />
                <Text1 text="“What risks do you take by going over her head?”" />
                <Text2 text="“How do you balance career consequences against safety concerns?”" />
              </div>
            </div>
          </Wrapper2>
        </div>
