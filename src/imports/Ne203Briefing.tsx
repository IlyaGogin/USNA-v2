import svgPaths from "./svg-aap8um7so6";
  ...
  return (
    <div className="relative size-full" data-name="NE-203: Briefing">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <img alt="" className="absolute max-w-none object-50%-50% object-cover size-full opacity-0 transition-opacity duration-500" src={imgNe203Briefing} onLoad={(e) => e.currentTarget.style.opacity = '1'} />
      </div>
      ...
      <div className="absolute inset-[118px_0_0_0] z-20">
        <div className="absolute bg-white h-[calc(100vh-118px)] left-[6.13%] right-[40.16%] rounded-tl-[4px] rounded-tr-[4px] top-0 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="content-stretch flex flex-col items-start px-[40px] py-[24px] relative">
              <BackgroundImage4>
          ...
          <div className="relative shrink-0 w-full bg-white border-t border-[rgba(13,0,77,0.15)]">
            <div className="flex flex-row items-center justify-end size-full">
              <div className="content-stretch flex items-center justify-end px-[40px] py-[16px] relative w-full">
                <div className="bg-[#ffce00] content-stretch flex gap-[12px] items-center justify-center px-[24px] py-[16px] relative rounded-[1000px] shrink-0 cursor-pointer hover:bg-[#ffd633] transition-colors" data-name="button">
        ...
        <div className="absolute bg-[rgba(0,0,0,0.76)] h-[calc(100vh-118px)] left-[60.76%] right-[6.13%] rounded-[4px] top-0 overflow-y-auto">
