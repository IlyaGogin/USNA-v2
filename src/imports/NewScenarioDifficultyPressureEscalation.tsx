import svgPaths from "./svg-c73lddutkn";
...
type InputRadioTextProps = {
  text: string;
};

function InputRadioText({ text }: InputRadioTextProps) {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0">
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[22px] leading-[22px] relative shrink-0 text-[#171717] text-[18px] w-[375px]">{text}</p>
    </div>
  );
}
...
export default function NewScenarioDifficultyPressureEscalation() {
  return (
    <div className="bg-white relative size-full" data-name="New Scenario: Difficulty - Pressure Escalation">
            ...
            <div className="content-stretch flex flex-col gap-[56px] items-center px-[80px] py-[24px] relative size-full">
              <div className="content-stretch flex gap-[8px] items-start px-0 py-[8px] relative shrink-0 w-full" data-name="breadcrumb">
                ...
                <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="Item 2">
                  <p className="[text-underline-position:from-font] decoration-solid font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#171717] text-[14px] text-nowrap underline">Supported</p>
                  <div className="content-stretch flex items-center pb-0 pt-[2px] px-0 relative shrink-0" data-name="Icon Wrapper">
                    <div className="content-stretch flex items-center relative shrink-0 size-[14px]" data-name="navigation/next">
                      <Trim>
                        <path clipRule="evenodd" d={svgPaths.p3652d940} fill="var(--fill-0, #171717)" fillRule="evenodd" id="icon" />
                ...
                <div className="content-stretch flex items-center relative shrink-0" data-name="Item Active">
                  <p className="[text-underline-position:from-font] decoration-solid font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#171717] text-[14px] text-nowrap underline">Pressure Escalation</p>
                </div>
              </div>
              <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0">
                <div className="content-stretch flex flex-col gap-[8px] items-start leading-[28px] relative shrink-0 w-[856px]">
                  <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium relative shrink-0 text-[#171717] text-[20px] tracking-[-0.4px] w-full">Do you want to enable pressure escalation?</p>
                  <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal relative shrink-0 text-[#5d5d5d] text-[18px] w-full">AI will introduce complications if the student finds an easy solution too quickly, avoids making a clear decision, or reaches the midpoint without engaging deeply.</p>
                </div>
                <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                  <div className="bg-[#f6f6fb] content-stretch flex items-center p-[24px] relative rounded-[12px] shrink-0 w-[856px]">
                    ...
                    <div className="basis-0 content-stretch flex gap-[16px] grow items-center min-h-px min-w-px relative shrink-0">
                      <div className="bg-[rgba(29,82,130,0.08)] content-stretch flex items-center p-[12px] relative rounded-[4px] shrink-0">
                        <Wrapper1>
                          <g id="Check">
                            <path d={svgPaths.p50cd900} fill="var(--fill-0, #171717)" id="Vector" />
                          </g>
                        </Wrapper1>
                      </div>
                      <InputRadioText text="Yes, enable pressure escalation" />
                    </div>
                  </div>
                  <div className="bg-[#f6f6fb] content-stretch flex items-center p-[24px] relative rounded-[12px] shrink-0 w-[856px]">
                    <div aria-hidden="true" className="absolute border border-[rgba(13,0,77,0.15)] border-solid inset-0 pointer-events-none rounded-[12px]" />
                    <div className="basis-0 content-stretch flex gap-[16px] grow items-center min-h-px min-w-px relative shrink-0">
                      ...
                      <InputRadioText text="No, don’t use pressure escalation" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex flex-col gap-[20px] items-start pb-[24px] pt-[16px] px-[16px] relative w-full">
              ...
              <div className="content-stretch flex gap-[12px] items-center px-[16px] py-0 relative shrink-0">
                ...
                <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#5d5d5d] text-[14px] w-[408px]">Supported</p>
              </div>
            </div>
          </div>
        </div>
