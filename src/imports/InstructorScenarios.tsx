import svgPaths from "./svg-2wasbzlws9";
...
export default function InstructorScenarios() {
  return (
    <div className="bg-[#efeef7] relative size-full" data-name="Instructor: Scenarios">
      <div className="absolute bg-[#e8e6f3] content-stretch flex flex-col gap-[32px] h-[1039px] items-center left-0 p-[24px] top-[78px] w-[349px]">
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[7px] items-start relative shrink-0 w-full">
            ...
            <Wrapper>{`Philosophy & Psychology`}</Wrapper>
            <Wrapper>{`Language & Communication`}</Wrapper>
            <Text text="Coaching" />
          </div>
        </div>
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[280px]">
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input-checkbox">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Input">
                ...
                <p className="basis-0 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[16px]">Published</p>
              </div>
            </div>
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input-checkbox">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Input">
                ...
                <p className="basis-0 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[16px]">Draft</p>
              </div>
            </div>
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input-checkbox">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Input">
