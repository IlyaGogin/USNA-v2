import svgPaths from "./svg-a2fa3lnmfx";
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
              ...
              <Wrapper>
                <div className="relative shrink-0 size-[67px]">
                  ...
                  <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[22px] left-1/2 text-[#171717] text-[18px] text-center text-nowrap top-[calc(50%-10.5px)] translate-x-[-50%]">QA</p>
                </div>
                <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="input-radio">
                  <Helper text="Lieutenant" text1="Maintenance QA Officer" />
                </div>
              </Wrapper>
            </div>
          </div>
          ...
          <div className="absolute bg-[#e8e6f3] content-stretch flex flex-col gap-[24px] items-start left-0 p-[32px] right-[44.12%] rounded-[12px] top-0">
            ...
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[28px] relative shrink-0 text-[#171717] text-[18px] w-full">Chief Rodriguez privately asks you to “use discretion” this one time, mentioning his upcoming retirement and perfect record. You must choose between enforcing regulations and potentially damaging a good sailor’s career, or trusting his experience while risking flight safety and your own integrity.</p>
              </div>
            </div>
            <Frame2043682545Helper />
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[28px] min-w-full relative shrink-0 text-[#171717] text-[18px] w-[min-content]">Navigate the tension between professional standards, safety, and the human element of leadership while maintaining unit effectiveness. The scenario tests your ability to uphold standards while treating people with dignity.</p>
              </div>
            </div>
          </div>
            ...
            <div className="content-stretch flex items-center relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                  ...
                  <div className="content-stretch flex items-center justify-center px-0 py-[12px] relative shrink-0 w-full">
                    <p className="basis-0 font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal grow leading-[28px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[18px]">Treats Chief Rodriguez with respect while remaining firm on regulations</p>
                  </div>
                </div>
              </div>
            </div>
