import svgPaths from "./svg-lpbbxjcmd0";
...
function Frame2043682545BackgroundImage() {
  return (
    <BackgroundImage3>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 432 1">
        <line id="Line 5" stroke="var(--stroke-0, #0D004D)" strokeOpacity="0.15" x2="432" y1="0.5" y2="0.5" />
      </svg>
    </BackgroundImage3>
  );
}
...
export default function InstructorStudentDetails() {
  return (
    <div className="bg-[#efeef7] relative size-full" data-name="Instructor: Student Details">
      ...
      <div className="absolute content-stretch flex flex-col inset-[78px_30.09%_0_32.41%] items-start px-[40px] py-[32px]">
        <div className="basis-0 bg-[#e8e6f3] grow min-h-px min-w-px relative rounded-[12px] shrink-0 w-full">
          <div className="size-full">
            <div className="content-stretch flex flex-col gap-[40px] items-start px-[24px] py-[32px] relative size-full">
              ...
              <div className="basis-0 content-stretch flex flex-col grow items-start justify-between max-h-[560px] min-h-px min-w-px pb-[16px] pt-0 px-0 relative shrink-0 w-full">
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium gap-[16px] items-center relative shrink-0 w-full">
                    <BackgroundImage1 text="Advanced" text1="Constraints" />
                    <p className="leading-[56px] relative shrink-0 text-[#171717] text-[48px] text-nowrap tracking-[-0.96px]">90%</p>
                  </div>
                ...
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium gap-[16px] items-center relative shrink-0 w-full">
                    ...
                    <p className="leading-[56px] relative shrink-0 text-[#171717] text-[48px] text-nowrap tracking-[-0.96px]">70%</p>
                  </div>
                  <div className="bg-[rgba(0,116,221,0.1)] content-stretch flex h-[2px] items-start relative shrink-0 w-full">
                ...
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium gap-[16px] items-center relative shrink-0 w-full">
                    ...
                    <p className="leading-[56px] relative shrink-0 text-[#171717] text-[48px] text-nowrap tracking-[-0.96px]">95%</p>
                  </div>
                  <div className="bg-[rgba(0,116,221,0.1)] content-stretch flex h-[2px] items-start relative shrink-0 w-full">
                ...
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium gap-[16px] items-center relative shrink-0 w-full">
                    ...
                    <p className="leading-[56px] relative shrink-0 text-[#171717] text-[48px] text-nowrap tracking-[-0.96px]">80%</p>
                  </div>
                  <div className="bg-[rgba(0,116,221,0.1)] content-stretch flex h-[2px] items-start relative shrink-0 w-full">
      ...
      <div className="absolute content-stretch flex flex-col gap-[32px] inset-[78px_0_0_69.91%] items-start pb-0 pl-0 pr-[40px] pt-[32px]">
        <div className="bg-[#e8e6f3] content-stretch flex flex-col h-[491px] items-start justify-between px-[24px] py-[32px] relative rounded-[12px] shrink-0 w-[480px]">
          <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
          ...
          <Frame2043682545BackgroundImage />
          <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
            <div className="content-stretch flex items-start justify-between px-0 py-[16px] relative shrink-0 w-full">
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                ...
                <BackgroundImage2 text="Badge earned" text1="Leadership Excellence" />
              </div>
            ...
            <div className="content-stretch flex items-start justify-between px-0 py-[16px] relative shrink-0 w-full">
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                ...
                <BackgroundImage2 text="Scenario completed" text1="Milgram Obedience" />
              </div>
              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#5d5d5d] text-[14px] text-nowrap text-right">1 day ago</p>
            </div>
            <div className="content-stretch flex items-start justify-between px-0 py-[16px] relative shrink-0 w-full">
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                <BackgroundImageAndText2 text="78" />
                <BackgroundImage2 text="Scenario completed" text1="The Challenger Decision" />
              </div>
              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#5d5d5d] text-[14px] text-nowrap text-right">1 day ago</p>
            </div>
            <div className="content-stretch flex items-start justify-between px-0 py-[16px] relative shrink-0 w-full">
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                <BackgroundImageAndText2 text="78" />
                <BackgroundImage2 text="Scenario completed" text1="Abu Ghraib" />
              </div>
              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#5d5d5d] text-[14px] text-nowrap text-right">1 day ago</p>
            </div>
            {[...Array(2).keys()].map((_, i) => (
              <div className="content-stretch flex items-start justify-between px-0 py-[16px] relative shrink-0 w-full">
                ...
                <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                  ...
                  <BackgroundImage2 text="Badge earned" text1="Moral Reasoning Foundation" />
                </div>
                <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#5d5d5d] text-[14px] text-nowrap text-right">1 day ago</p>
              </div>
            ))}
