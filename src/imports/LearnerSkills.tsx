import svgPaths from "./svg-mm111xqyth";
...
import { imgTrackColor, imgProgress } from "./svg-rj77y";
          ...
          <div className="flex flex-col items-center justify-center size-full">
            <div className="content-stretch flex flex-col items-center justify-center px-[16px] py-[48px] relative size-full">
              <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
                ...
                <Group8Helper additionalClassNames="ml-[565.63px] mt-[188px]" />
                <Group8Helper additionalClassNames="ml-[493.63px] mt-[356px]" />
                <Group8Helper additionalClassNames="ml-[340.63px] mt-[332px]" />
                <Group8Helper additionalClassNames="ml-[288.63px] mt-[200px]" />
                <Group8Helper additionalClassNames="ml-[408.13px] mt-[102px]" />
                <div className="col-end-auto col-start-1 h-[254.5px] ml-[290.13px] mt-[103.5px] relative row-end-auto row-start-1 w-[277px]">
                  <div className="absolute inset-[-0.24%_-0.23%_-0.22%_-0.22%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 278.237 255.656">
                      <path d={svgPaths.p18c6380} fill="var(--fill-0, #0074DD)" fillOpacity="0.15" id="Vector 1" stroke="var(--stroke-0, #0074DD)" />
                    </svg>
                  </div>
                </div>
              </div>
