import svgPaths from "./svg-q31vo4zj4l";
...
export default function NewScenarioContentObjectives() {
  return (
    <div className="bg-white relative size-full" data-name="New Scenario: Content - Objectives">
          ...
          <div className="flex flex-col items-center size-full">
            <div className="content-stretch flex flex-col gap-[56px] items-center px-[80px] py-[24px] relative size-full">
              <div className="content-stretch flex gap-[8px] items-start px-0 py-[8px] relative shrink-0 w-full" data-name="breadcrumb">
                ...
                <div className="content-stretch flex gap-[5px] items-center relative shrink-0" data-name="Item 4">
                  <p className="[text-underline-position:from-font] decoration-solid font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#171717] text-[14px] text-nowrap underline">{`Moral Perception: Social Influences & Personal Inegrity`}</p>
                  <div className="content-stretch flex items-center pb-0 pt-[2px] px-0 relative shrink-0" data-name="Icon Wrapper">
                    <div className="content-stretch flex items-center relative shrink-0 size-[14px]" data-name="navigation/next">
                      <Trim>
                        <path clipRule="evenodd" d={svgPaths.p3652d940} fill="var(--fill-0, #171717)" fillRule="evenodd" id="icon" />
                ...
                <div className="content-stretch flex items-center relative shrink-0" data-name="Item Active">
                  <p className="[text-underline-position:from-font] decoration-solid font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#171717] text-[14px] text-nowrap underline">Objectives</p>
                </div>
              </div>
              <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0">
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-[856px]">
                  <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#171717] text-[20px] tracking-[-0.4px] w-full">Which learning objectives should it include?</p>
                </div>
                <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                  <div className="bg-[#f6f6fb] relative rounded-[12px] shrink-0 w-full">
                    ...
                    <Wrapper1>
                      ...
                      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[22px] leading-[22px] relative shrink-0 text-[#171717] text-[18px] w-[744px]">Identify how cultures, religions, and philosophies shape moral perception</p>
                    </Wrapper1>
                  </div>
                  <Wrapper>
                    ...
                    <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[22px] leading-[22px] relative shrink-0 text-[#171717] text-[18px] w-[744px]">Evaluate appropriate ways to engage in moral discourse despite differences</p>
                  </Wrapper>
                  <Wrapper>
                    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="_input-checkbox-item">
                      <Checkbox />
                    </div>
                    <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium h-[22px] leading-[22px] relative shrink-0 text-[#171717] text-[18px] w-[744px]">Apply to military leadership case study</p>
                  </Wrapper>
                </div>
