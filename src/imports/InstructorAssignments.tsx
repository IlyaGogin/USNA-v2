import svgPaths from "./svg-jfcfjat4v5";
  ...
  return (
    <div className="bg-white h-[48px] relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-0 relative size-full">{children}</div>
      </div>
    </div>
  );
}
...
function TableCellText({ text }: TableCellTextProps) {
  return (
    <Wrapper1>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[24px] overflow-ellipsis overflow-hidden relative shrink-0 text-[#171717] text-[16px] text-nowrap w-full">{text}</p>
    </Wrapper1>
  );
}
type TextProps = {
  ...
  return (
    <Wrapper>
      <div className="bg-[#ebf9f0] content-stretch flex items-center pb-[4px] pt-[2px] px-[4px] relative rounded-[4px] shrink-0" data-name="label-static">
        <LabelWrapperText text="Completed" />
      </div>
    </Wrapper>
  );
}
      ...
      <div className="bg-[#ffe7e5] content-stretch flex items-center pb-[5px] pt-[2px] px-[5px] relative rounded-[4px] shrink-0" data-name="label-static">
        <div className="content-stretch flex items-center justify-center px-[4px] py-0 relative shrink-0" data-name="Label Wrapper">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#b20900] text-[16px] text-center text-nowrap">
            <p className="leading-[20px]">Overdue</p>
          </div>
        </div>
      </div>
    </Wrapper>
...
export default function InstructorAssignments() {
  return (
    <div className="bg-[#efeef7] relative size-full" data-name="Instructor: Assignments">
      <div className="absolute bg-[#e8e6f3] content-stretch flex flex-col gap-[32px] h-[1039px] items-center left-0 p-[24px] top-[78px] w-[349px]">
        <div className="bg-[#ffce00] relative rounded-[1000px] shrink-0 w-full" data-name="button">
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex gap-[12px] items-center justify-center px-[24px] py-[16px] relative w-full">
              <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[16px] text-black text-center text-nowrap">Create Assignment</p>
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[280px]">
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input-checkbox">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Input">
                ...
                <p className="basis-0 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[16px]">In progress</p>
              </div>
            </div>
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input-checkbox">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Input">
                ...
                <p className="basis-0 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[16px]">Completed</p>
              </div>
            </div>
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input-checkbox">
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Input">
                ...
                <p className="basis-0 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[16px]">Overdue</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="content-stretch flex items-center relative shrink-0 w-full z-[1]" data-name="Table">
            ...
            <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="_table-column">
              <div className="bg-white h-[48px] relative shrink-0 w-full" data-name="_table-header">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[2px] items-center px-[16px] py-0 relative size-full">
                    <p className="basis-0 font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold grow leading-[24px] min-h-px min-w-px overflow-ellipsis overflow-hidden relative shrink-0 text-[#171717] text-[16px] text-nowrap">Assignment</p>
              ...
              {[...Array(19).keys()].map((_, i) => (
                <TableCellText text="Crisis Communication Under Pressure" />
              ))}
            </div>
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-[160px]" data-name="_table-column">
              <TableHeaderText text="Completed" />
              {[...Array(19).keys()].map((_, i) => (
                <Wrapper1>
                  <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[24px] overflow-ellipsis overflow-hidden relative shrink-0 text-[#045caf] text-[16px] text-nowrap w-full">25/28</p>
                </Wrapper1>
              ))}
            </div>
            <div className="content-stretch flex flex-col items-start relative shrink-0 w-[320px]" data-name="_table-column">
              <TableHeaderText text="Due" />
              {[...Array(19).keys()].map((_, i) => (
                <TableCellText text="Tue Jan 18, 2026" />
              ))}
            </div>
            <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="_table-column">
