import svgPaths from "./svg-rb6gmn5z8x";
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium gap-[8px] items-start justify-center pl-0 pr-[16px] py-0 relative w-full">
          <p className="leading-[16px] relative shrink-0 text-[#5d5d5d] text-[14px] w-full">{text}</p>
          <p className="leading-[22px] relative shrink-0 text-[#171717] text-[18px] w-full">{text1}</p>
        </div>
      </div>
    </div>
  );
...
export default function InstructorDashboard() {
  return (
    <div className="bg-[#efeef7] relative size-full" data-name="Instructor: Dashboard">
      <div className="absolute bg-[#e8e6f3] content-stretch flex flex-col gap-[32px] inset-[78px_67.59%_0_0] items-start overflow-clip p-[40px]">
        <div className="content-stretch flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium gap-[20px] items-start relative shrink-0 w-[377px]">
          <div className="leading-[56px] relative shrink-0 text-[#171717] text-[48px] tracking-[-0.96px] w-full">
              ...
              <div className="content-stretch flex flex-col gap-[24px] items-start justify-center p-[16px] relative w-full">
                <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full">
                  <div className="basis-0 content-stretch flex grow items-center justify-center min-h-px min-w-px px-0 py-[8px] relative shrink-0">
                    <p className="basis-0 font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium grow leading-[22px] min-h-px min-w-px relative shrink-0 text-[#e8e8e8] text-[18px]">Avg. Class Score</p>
                  </div>
      ...
      <div className="absolute content-stretch flex flex-col gap-[40px] inset-[78px_30.09%_0_32.41%] items-start px-[40px] py-[32px]">
      ...
      <div className="absolute content-stretch flex flex-col gap-[24px] inset-[78px_0_0_69.91%] items-start pb-0 pl-[24px] pr-[40px] pt-[32px]">
