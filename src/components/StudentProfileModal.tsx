import svgPaths from "../imports/svg-wqkaiqu7mk";
...
export default function StudentProfileModal({ onClose, onSignOut }: StudentProfileModalProps) {
  return (
    <>
      {/* Backdrop */}
      <div 
      ...
      {/* Modal */}
      <div className="fixed top-[70px] right-[24px] w-[280px] z-50">
        <div className="bg-white relative rounded-[8px] shadow-[0px_5px_24px_4px_rgba(13,0,77,0.05),0px_13px_19px_2px_rgba(13,0,77,0.1),0px_7px_8px_-4px_rgba(13,0,77,0.15)]">
          <div className="flex flex-col items-center">
            <div className="content-stretch flex flex-col gap-[4px] items-center overflow-clip pb-[16px] pt-0 px-[16px] relative w-full">
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                <button
                  className="content-stretch flex gap-[8px] items-start px-0 py-[24px] relative shrink-0 w-full hover:bg-[#f6f6fb] transition-colors cursor-pointer"
                  onClick={onClose}
                >
                  ...
                  <p className="basis-0 font-medium grow leading-[16px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[14px] text-left">Personal Details</p>
                ...
                >
                  <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(13,0,77,0.15)] border-solid inset-0 pointer-events-none" />
                  <p className="basis-0 font-medium grow leading-[16px] min-h-px min-w-px relative shrink-0 text-[#171717] text-[14px] text-left">{`Data & Privacy`}</p>
                  <div className="content-stretch flex items-center relative shrink-0 size-[16px]" data-name="Trail Icon">
                    <Trim />
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center min-h-px min-w-px relative shrink-0">
                    ...
                    <p className="font-medium leading-[16px] relative shrink-0 text-[#171717] text-[14px] text-nowrap text-left">Revibe connection</p>
                  </div>
                  <div className="content-stretch flex items-center relative shrink-0 size-[16px]" data-name="Trail Icon">
                    <Trim />
                  </div>
